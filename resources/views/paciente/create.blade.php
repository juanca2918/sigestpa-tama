                    ...
                    @method('post')
                        <div class="form-group">
                            ...
                            <div class="input-group m-3">
                                ...
                                <input type="text" class="form-control" placeholder="Nombre" name="nom" aria-describedby="basic-addon1">
                            </div>
                            {{--Fin Div Nombre--}}
                            ...
                            <div class="input-group m-3">
                                ...
                                <input type="text" class="form-control" placeholder="Genero" name="genro" aria-describedby="basic-addon1">
                            </div>
                            ...
                            <div class="input-group m-3">
                                ...
                                <input type="text" class="form-control" placeholder="Estado Civil" name="ecivil" aria-describedby="basic-addon1">
                            </div>
                            ...
                            <div class="input-group m-3">
                                ...
                                <input type="text" class="form-control" placeholder="Seguro Social"
