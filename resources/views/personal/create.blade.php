                    ...
                    @method('POST')
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group m-3" hidden>
                                ...
                                <input type="text" name="idpers" class="form-control" placeholder="ID.Personal" aria-label="Id.Personal"
                            ...
                            <div class="input-group m-3">
                                ...
                                <input type="text" class="form-control" placeholder="Numero de Documento"
                                       name="numerodoc" aria-describedby="basic-addon1">
                            </div>
                            ...
                            <div class="input-group m-3">
                                ...
                                <input type="text" class="form-control" placeholder="Telefono" name="telefono" aria-describedby="basic-addon1">
                            </div>
                            {{--Fin Div Telefono--}}
                            ...
                            <div class="input-group m-3">
                                ...
                                <input type="text" class="form-control" placeholder="Estado Civil" name="estacivil" aria-describedby="basic-addon1">
                            </div>
                            ...
                            <div class="input-group m-3">
                                ...
                                <input type="text" class="form-control" placeholder="Seguro Social" name="segusocial" aria-describedby="basic-addon1">
                            </div>
